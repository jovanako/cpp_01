...
/*   Updated: 2026/03/04 21:19:49 by jkovacev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	- Test 1: Heap allocation	
	...
	->	call announce()
	->	delete it manually
	->	observe constructor and destructor messages (constructor message
		appears immediately after newZombie, destructor message only 
		after 'delete')
